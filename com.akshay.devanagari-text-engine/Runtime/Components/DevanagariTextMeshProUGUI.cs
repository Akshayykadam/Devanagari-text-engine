...
{
    /// <summary>
    /// Extended TextMeshProUGUI component with Devanagari text support (Hindi/Marathi).
    /// Provides automatic text processing, numeral conversion,
    /// and easy access to the original logical text.
    /// </summary>
    [AddComponentMenu("Devanagari Text/Devanagari TextMeshPro - UGUI")]
    [RequireComponent(typeof(RectTransform))]
    [DisallowMultipleComponent]
    [ExecuteAlways]
    public class DevanagariTextMeshProUGUI : MonoBehaviour
    {
        [Header("Language")]
        [SerializeField]
        ...
        [SerializeField]
        [Tooltip("TMP Font Asset name for English/Latin text in Legacy Mode")]
        ...
        /// <summary>
        /// Gets or sets the original text (before processing).
        /// </summary>
        ...
        /// <summary>
        /// Gets the underlying TextMeshProUGUI component.
        /// </summary>
        ...
        private void ProcessAndApply()
        {
            ...
            try
            {
                ...
                if (_debugMode)
                    Debug.Log($"[DevanagariTextMeshProUGUI] '{gameObject.name}' ({_language}) | " +
                              $"Original: '{_originalText}' | Processed: '{result}'");
            }
            finally { _isProcessing = false; }
        }
        
        /// <summary>Forces a refresh of the text processing.</summary>
